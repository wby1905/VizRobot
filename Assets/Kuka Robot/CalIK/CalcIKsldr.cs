...
public class CalcIKsldr : MonoBehaviour
{
    ...
    public float px = 4f, py = 0f, pz = 8f;
    ...
    void Update()
    {
        ...
        px = target.transform.position.x;
        py = target.transform.position.y;
        pz = target.transform.position.z;
        rx = target.transform.rotation.eulerAngles.x;
        ry = target.transform.rotation.eulerAngles.y;
        rz = target.transform.rotation.eulerAngles.z;

        ax = Mathf.Cos(rz * Mathf.Deg2Rad) * Mathf.Cos(ry * Mathf.Deg2Rad);
        ay = Mathf.Sin(rz * Mathf.Deg2Rad) * Mathf.Cos(ry * Mathf.Deg2Rad);
        az = -Mathf.Sin(ry * Mathf.Deg2Rad);
        ...
        bx = Mathf.Cos(rx * Mathf.Deg2Rad) * Mathf.Sin(ry * Mathf.Deg2Rad) * Mathf.Cos(rz * Mathf.Deg2Rad) - Mathf.Sin(rx * Mathf.Deg2Rad) * Mathf.Sin(rz * Mathf.Deg2Rad);
        by = Mathf.Cos(rx * Mathf.Deg2Rad) * Mathf.Sin(ry * Mathf.Deg2Rad) * Mathf.Sin(rz * Mathf.Deg2Rad) - Mathf.Sin(rx * Mathf.Deg2Rad) * Mathf.Cos(rz * Mathf.Deg2Rad);
        bz = Mathf.Cos(rx * Mathf.Deg2Rad) * Mathf.Cos(ry * Mathf.Deg2Rad);
